...
{    
    ...
    function create($m_item_id, $m_item_name, $m_item_ext_id){
    ...
    function update($m_item_id, $m_item_name, $m_item_ext_id){
    ...
    function upload($kode_hmp, $nama, $kode_saga){       
        $query1 = $this->db->insert(self::$table1,array(
            'm_item_id'         => $kode_hmp,
            'm_item_name'       => $nama,
            'm_item_ext_id'     => $kode_saga
        ));
        if($query1){
            return TRUE;
        }
