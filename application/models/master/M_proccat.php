...
{    
    ...
    function index()
    {
        ...
        $offset = ($page-1)*$rows;      
        $sort   = isset($_POST['sort']) ? strval($_POST['sort']) : 'm_process_cat_name';
    ...
    function update($m_process_cat_id, $m_process_cat_name) {
    ...
    function delete($m_process_cat_id)
    {
        $query = $this->db->delete(self::$table1, array('m_process_cat_id' => $m_process_cat_id));
        if($query)
        {
            return json_encode(array('success'=>true));
        }
