...
class User extends CI_Controller {
    ...
    function create(){
        ...
        echo $this->record->create($a_user_name, $a_user_username, $a_user_password, $a_user_level, $m_process_cat_id);
    }     
    ...
    function update($a_user_id=null){
        ...
        echo $this->record->update($a_user_id, $a_user_name, $a_user_username, $a_user_password, $a_user_level, $m_process_cat_id);
    }
