...
<head>   
    ...
    <script type="text/javascript" src="<?=base_url('assets/easyui/jquery.pivotgrid.js')?>"></script>
...
<body>    
    ...
    <div class="easyui-layout" fit="true" style="width:700px;height:350px;">
        ...
        <div data-options="region:'south',split:false" style="height:100px;">
            <h1 align="center">Aplikasi WIP Ver. 1.0</h1>
            <center>©2018 PT. Sagateknindo Sejati. All Rights Reserved.</center>
        </div>
