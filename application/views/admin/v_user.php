...
<table id="grid-admin_user"
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'m_process_cat_name'"   width="50" align="center" sortable="true">Proses</th>
        </tr>
    </thead>
</table>
...
<!-- Dialog Input Form -->
<div id="dlg-admin_user" class="easyui-dialog" style="width:400px; height:300px; padding: 10px 20px" closed="true" buttons="#dlg_buttons-admin_user">
    <form id="fm-admin_user" method="post" novalidate>        
        ...
        <div class="fitem">
            ...
            <input type="text" id="m_process_cat_id" name="m_process_cat_id" style="width:150px;" class="easyui-combobox"
                data-options="url:'<?php echo site_url('admin/user/getProses'); ?>',
...
<div id="dlg_buttons-admin_user">
    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="width:75" iconCls="icon-ok" onclick="adminUserSave();">Simpan</a>
